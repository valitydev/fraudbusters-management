...
public class WbListDaoImplTest {
    ...
    void shouldGetNothingRottenRecords() {
        WbListRecordsRecord freshRecord1 = TestObjectFactory.createWbListRecordsRecord(
                TestObjectFactory.randomString());
        freshRecord1.setTimeToLive(LocalDateTime.now().plusDays(1));
        freshRecord1.setValue(TestObjectFactory.randomString());
        WbListRecordsRecord freshRecord2 = TestObjectFactory.createWbListRecordsRecord(
                TestObjectFactory.randomString());
        freshRecord2.setTimeToLive(LocalDateTime.now().plusDays(2));
        freshRecord2.setValue(TestObjectFactory.randomString());
    ...
    void shouldGetRottenRecords() {
        WbListRecordsRecord rotRecord1 = TestObjectFactory.createWbListRecordsRecord(TestObjectFactory.randomString());
        rotRecord1.setTimeToLive(LocalDateTime.now().minusDays(1));
        rotRecord1.setValue(TestObjectFactory.randomString());
        WbListRecordsRecord rotRecord2 = TestObjectFactory.createWbListRecordsRecord(TestObjectFactory.randomString());
        rotRecord2.setTimeToLive(LocalDateTime.now().minusDays(2));
        rotRecord2.setValue(TestObjectFactory.randomString());
        WbListRecordsRecord freshRecord1 = TestObjectFactory.createWbListRecordsRecord(
                TestObjectFactory.randomString());
        freshRecord1.setTimeToLive(LocalDateTime.now().plusDays(1));
        freshRecord1.setValue(TestObjectFactory.randomString());
