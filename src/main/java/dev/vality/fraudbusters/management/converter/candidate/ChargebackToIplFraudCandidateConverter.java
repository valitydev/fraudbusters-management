...
@Component
public class ChargebackToIplFraudCandidateConverter extends ChargebackToFraudCandidateConverter {
    ...
    public FraudDataCandidate toCandidate(Chargeback chargeback, String batchId) {
        ...
        candidate.setValue(clientInfo.getIp());
        candidate.setType(CandidateListName.IP);
        return candidate;
    }
}
