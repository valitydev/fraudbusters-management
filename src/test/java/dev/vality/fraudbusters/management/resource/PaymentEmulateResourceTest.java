...
import dev.vality.fraudbusters.management.resource.payment.PaymentEmulateResource;
import dev.vality.fraudbusters.management.service.payment.PaymentEmulateService;
import dev.vality.fraudbusters.management.utils.GroupRowToModelMapper;
...
@ContextConfiguration(classes = {PaymentEmulateResource.class, PaymentGroupDao.class, PaymentTemplateDao.class,
        ...
        TemplateModelToTemplateConverter.class, PaymentEmulateService.class})
